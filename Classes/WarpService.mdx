...
local Player_netisu = Game:GetService("Players"):GetPlayer("netisu")
if Player_netisu ~= nil then 
    WarpService:Teleport(123, Player_netisu)
end
```
...
local Player_netisu = Game:GetService("Players"):GetPlayer("netisu")
if Player_netisu ~= nil then 
    WarpService:TeleportToPrivateServer(123, Player_netisu)
end
```
