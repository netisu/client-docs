---
title: 'MeshPart'
description: '`MeshPart` allows you to place `.glb` meshes in the game world'
icon: 'mushroom'
---
<Info>
...
<Note>
  Netisu's `MeshPart` only support `.glb`. If you manage to import a `.gltf`: it won't work in playtest or exported build.
</Note>
## Properties
